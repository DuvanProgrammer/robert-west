                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-9 text-center">
                        ...
                        <form action="" className={styles.rwFormSearch}>
                            ...
                            <input type="mail" placeholder="Ingresa tu búsqueda" className="font-merriweather"/>
                        </form>
